...
## 🛠️ Estado del Arte y Tecnologías
...
### 👁️ 3. `06_vistas.sql` — Capa de Abstracción y Optimización
...
1. 🏃‍♂️ Ejecutar primero el modelo base de tablas de la rama `main`.
    
2. 📊 `@@04_agregados.sql` (Validación de métricas).
    
3. 🔀 `@@05_subconsultas.sql` (Verificación de filtros lógicos).
    
4. 👁️ `@@06_vistas.sql` (Despliegue de la capa analítica final).
    

_Estudiante de Ingeniería de Software — Universidad de El Salvador (UES)_